...
```{js, code=xfun::read_utf8("clipboard_plugin.js"), echo=FALSE}
```
...
<img src="dialog_box.png" alt="Screenshot of getcensus Stata dialog box" align="center" width="350" style="border:0.75px solid #0C61A4;"/>
